...
interface PropsNav {}
export default function NavUnic(props: PropsNav) {
  return (
    <>
        ...
        <Disclosure as="nav" className=" nav bg-gray-800  h-24 items-center">
          <div className=" mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div>
                <div className="flex items-center justify-center bg-white rounded-full w-14 h-16 text-black text-2xl font-bold">
                  MP
                </div>
              </div>
            </div>
