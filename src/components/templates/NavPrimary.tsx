...
const navigation = [
  ...
  { name: "Cadastro", href: "/layout/cadastro", current: false },
];
...
export default function NavPrimary(props: PropsNav) {
  return (
    <>
      <nav className="nav  justify-around items-center h-[100px]">
        <Disclosure as="nav" className=" nav bg-gray-800  h-24 items-center justify-between">
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex  flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className= " mt-[20px] hidden sm:ml-6 sm:block  ">
                  <div className="flex space-x-32 menu ml-[50px]">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
          ...
          <DisclosurePanel className="sm:hidden nav ">
            <div className="space-y-1 px-2 pb-3 pt-2 nav menu">
              {navigation.map((item) => (
                <DisclosureButton
                  key={item.name}
                  as="a"
