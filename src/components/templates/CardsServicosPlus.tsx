    ...
    return(
        ...
        <Accordion type="single" collapsible  >
            <AccordionItem value="item-1" className="bg-white  rounded-md ">
              <AccordionTrigger>Auditoria de segurança da informação</AccordionTrigger>
              <AccordionContent>
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1" className="bg-white  rounded-md">
              <AccordionTrigger>
              Treinamento de sistemas feitos pela Everybody B tech e de outras empresas como PowerBi, excel, figma e outros
              </AccordionTrigger>
              <AccordionContent>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia,
                quos? Dolore iusto totam provident repellat accusamus similique
          ...
          <Accordion type="single" collapsible>
            <AccordionItem value="item-1" className="bg-white  rounded-md">
              ...
              <AccordionContent>
              Cashback Em serviços futuros, treinamentos gratuitos e mais. exclusivo caso para clientes que alcancem as metas de igualdade
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
